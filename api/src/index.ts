...
async function startApolloServer() {
    ...
    app.use('/accounts', require(path.join(__dirname, 'routes', 'accounts.routes.ts')));
    app.use('/oracle', require(path.join(__dirname, 'routes', 'oracle.routes.ts')));
    app.use('/xumm', require(path.join(__dirname, 'routes', 'xumm.routes.ts')));
