...
const getAppIndexJS = process.env.NODE_ENV == 'production'
          ? 'src/index'
          : 'src/index'
...
module.exports = {
  ...
  appIndexJs: resolveModule(resolveApp, getAppIndexJS),
  ...
  mainIndexJs: resolveModule(resolveApp, 'src/views/main/index'),
  popupIndexJs: resolveModule(resolveApp, 'src/views/popup/index'),
  optionsIndexJs: resolveModule(resolveApp, 'src/views/options/index'),
  ...
  inject: resolveModule(resolveApp, 'src/inject'),
};
