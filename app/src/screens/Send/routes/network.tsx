                    ...
                    <div className={style.inner}>
                        ...
                        <div className={style.foreground}>
                            ...
                            <div className={style.container}>
                                ...
                                <div className={style.pageTitle}>SELECT NETWORK</div>

                                <div className={style.accountContainer}>
                                {
                                    storeContext.networks ? 
                                    JSON.parse(storeContext.networks).map((network, index)=> 
                                        <div className={style.networkContainer}>
                                            <div className={`${style.circle} ${networkColors[index]? style[networkColors[index]] :null}`}></div>
                                            <div>{network.name}</div>
                                            <div className={style.address}>{network.wss}</div>
                                        </div>
